...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      '#gcConsent[hidden]{display:none!important}' +
      ...
      '#gcConsent button:focus-visible{outline:2px solid #fff;outline-offset:3px}' +
      ...
      '@media(max-width:560px){#gcConsent{right:10px;bottom:10px;width:calc(100vw - 20px);padding:15px}#gcConsentActions{justify-content:stretch}#gcConsent button{flex:1 1 auto;min-height:40px}}';
  ...
  function render() {
    ...
    // 保留程式介面給未來的隱私頁內連結使用，但不在頁面上顯示常駐按鈕。
    window.gcOpenPrivacySettings = function () {
      banner.hidden = false;
